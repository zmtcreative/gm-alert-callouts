...
// Initalize a map of SVG icons for various alert types
func InitAlertCalloutsIcons() map[string]string {
	// Set core list of icons (these will be used for the default alert types)
	...
	// Set aliases for additional alert types and the icons they
	// will use from the list above.
